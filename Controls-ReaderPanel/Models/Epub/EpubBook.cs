...
namespace Richasy.Controls.Reader.Models.Epub
{
    ...
    public abstract class EpubFile
    {
        ...
        {
            return obj is EpubFile file &&
                   AbsolutePath == file.AbsolutePath;
        }

        public override int GetHashCode()
        {
            return -1224100781 + EqualityComparer<string>.Default.GetHashCode(AbsolutePath);
        }
    }
    ...
    public class EpubTextFile : EpubFile
    {
        ...
        {
            string text = Regex.Replace(TextContent, @"<[^>]*>", string.Empty);
            return text;
        }
    }
}
